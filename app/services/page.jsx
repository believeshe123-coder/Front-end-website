              ...
              <div className="grid gap-6 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
                <div>
                  ...
                  <div className="mt-5 grid gap-3">
                    <div className="rounded-xl bg-blue-50/70 p-4"><h3 className="font-black text-blue-950">Problem solved.</h3><p className="mt-1 leading-7 text-slate-700">{section.problem}</p></div>
