      ...
      <section className="site-section bg-stone-50">
        {submitted ? (
          <div className="mx-auto max-w-4xl rounded-2xl border border-blue-100 bg-white p-6 shadow-2xl shadow-blue-950/10 md:p-8">
            ...
            <p className="mt-4 text-lg leading-8 text-slate-700">We&apos;ll review your information and contact you to learn more about your business, answer any questions, and discuss the support options that make the most sense for your needs.</p>
          </div>
        ) : (
