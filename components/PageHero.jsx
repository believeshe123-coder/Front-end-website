...
export function PageHero({
  ...
  return (
    <section className="min-h-[calc(100vh-73px)] bg-gradient-to-br from-slate-50 via-white to-blue-50 px-6 py-20 lg:px-8">
      <div className="mx-auto max-w-7xl rounded-[2rem] bg-white p-8 shadow-xl shadow-slate-200/70 ring-1 ring-slate-200 md:p-12">
